...
This document gathers the project links, central timeline insight, an additional mechanism and optional social copy in one place.

## Project links

**Live application:** `https://attention-field-guide.netlify.app/`

**GitHub repository:** `https://github.com/shekar-maker/attention-field-guide`
...
### Additional mechanism — a systems perspective
...
- [ ] The complete mechanism set appears
...
- [ ] Timeline insight is ready to share
- [ ] FlashAttention entry is named, dated and sourced
